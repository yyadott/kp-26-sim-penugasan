      ...
      sections: [
        {
          ...
          children: [
            ...
            new Table({
              width: { size: 100, type: WidthType.PERCENTAGE },
              rows: [
                new TableRow({ children: [new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: 'Perihal', size: 22, font: 'Times New Roman' })] })], width: { size: 2000, type: WidthType.DXA }, borders: noBorder }), new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: `: ${surat.uraianKegiatan}`, size: 22, font: 'Times New Roman' })] })], borders: noBorder })] }),
                ...
                new TableRow({ children: [new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: 'Lokasi', size: 22, font: 'Times New Roman' })] })], borders: noBorder }), new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: `: ${surat.tempat}`, size: 22, font: 'Times New Roman' })] })], borders: noBorder })] }),
