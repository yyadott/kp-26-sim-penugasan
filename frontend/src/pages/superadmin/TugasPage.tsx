        ...
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            Kelola proses ajuan surat tugas dan pelacakan status penugasan instansi.
                ...
                <Link to="/operator/draft-ajuan" className="flex items-center justify-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-md shadow-blue-500/20 transition-all cursor-pointer">
