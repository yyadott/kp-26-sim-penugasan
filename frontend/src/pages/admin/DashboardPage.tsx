...
export const DashboardPage = () => {
  ...
  const tugasPadaTanggal = selectedDateKey
    ? tugasList.filter((item) => {
        const startKey = item.tanggalMulai ? item.tanggalMulai.slice(0, 10) : '';
        const endKey = item.tanggalSelesai ? item.tanggalSelesai.slice(0, 10) : '';
        return startKey <= selectedDateKey && endKey >= selectedDateKey;
      })
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
        ...
        <div className="space-y-2 z-10">
          ...
          <div className="pt-2">
            <button 
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-xl text-xs font-bold backdrop-blur-md border border-white/20 transition-all shadow-sm cursor-pointer"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <Link to="ajuan-pegawai" className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs hover:border-amber-300 transition-all flex flex-col justify-between block cursor-pointer">
          <div className="flex items-center justify-between">
        ...
        <Link to="pegawai" className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs hover:border-violet-300 transition-all flex flex-col justify-between block cursor-pointer">
          <div className="flex items-center justify-between">
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <button type="button" onClick={() => setShowCurrentPassword(!showCurrentPassword)} className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-blue-600 cursor-pointer">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-4 pr-12 font-mono text-sm text-slate-800 outline-none transition focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-100"
                  />
                  <button type="button" onClick={() => setShowNewPassword(!showNewPassword)} className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-blue-600 cursor-pointer">
              ...
              <div className="pt-2 flex justify-end gap-2">
                <button type="button" onClick={() => setIsPasswordModalOpen(false)} className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold rounded-xl transition-colors cursor-pointer">
                  Batal
                </button>
                <button type="submit" className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl transition-colors shadow-md shadow-blue-500/20 flex items-center gap-2 cursor-pointer">
